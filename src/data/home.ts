...
export const moods: Mood[] = [
   ...
   */
  {
    ...
    body: {
      nl: 'Siciliaanse pistache zonder kleurstof — kaki, niet knalgroen. In onze reviews 39 keer bij naam genoemd.',
      en: 'Sicilian pistachio without colouring — khaki, not bright green. Named 39 times in our Google reviews.',
      it: 'Pistacchio siciliano senza coloranti: cachi, non verde acceso. Citato 39 volte nelle recensioni.',
    },
    smaken: ['Pistacchio'],
  ...
  },
  {
    ...
    body: {
      nl: 'Sinaasappel met Aperol: bitter, fris en fel. Hij hangt op de poster en verdwijnt met het seizoen.',
      en: 'Orange with Aperol: bitter, fresh and bright. On the poster by the door, gone with the season.',
      it: 'Arancia e Aperol: amaro, fresco e acceso. Sul poster accanto alla porta, se ne va con la stagione.',
    },
